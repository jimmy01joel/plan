...
function exp_label_LOTE_1_eval_expression(context) {
    // 'Area: ' || Area || ' Ha'
...
function exp_label_LINDERO_2_eval_expression(context) {
    // Distance || 'm' || '\n' || Rumbo
...
function exp_label_VERTICES_3_eval_expression(context) {
    // 'P' || id
